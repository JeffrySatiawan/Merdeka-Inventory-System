    ...
    <div className="min-h-screen w-full flex items-center justify-center relative overflow-hidden bg-[#09090b]">
      ...
      >
        <div className="flex items-center gap-3 mb-8 justify-center">
          ...
          <div>
            <div className="font-bold text-xl tracking-tight">CycleCount</div>
            <div className="text-xs text-muted-foreground">Pharmacy Edition</div>
          </div>
        </div>
        ...
        <div className="text-center text-xs text-muted-foreground mt-6">
          Sistem Cycle Count untuk manajemen SKU apotek
        </div>
      </motion.div>
    </div>
  );
  ...
  return (
    <aside className="w-64 shrink-0 border-r border-white/5 bg-[#0a0a0b] h-screen sticky top-0 flex flex-col">
      <div className="p-5 flex items-center gap-3 border-b border-white/5">
        ...
        <div>
          <div className="font-semibold text-sm">CycleCount</div>
          <div className="text-[10px] text-muted-foreground">Pharmacy</div>
        </div>
      </div>
              ...
              >
                ...
                <div className="w-32 text-right shrink-0">
                  {e.assigned === 0 && !e.logged_in ? (
                    <span className="text-xs text-muted-foreground italic">Belum Login</span>
                  ) : (
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-1">
          Upload Excel/CSV dengan kolom: <span className="text-white">SKU Code</span>, <span className="text-white">Product Name</span>, <span className="text-white">Category</span> (FAST/MEDIUM/SLOW)
        </p>
      </div>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-white/[0.03] text-muted-foreground text-xs uppercase tracking-wider">
                    ...
                    <th className="text-left px-4 py-2">Last Counted</th>
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">Kelola karyawan & bobot kerja</p>
        </div>
        <Button
          onClick={() => {
            setEditing(null);
...
function SettingsView() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Cycle Count Settings</h1>
        <p className="text-muted-foreground text-sm mt-1">Atur interval per kategori & jam kerja</p>
      </div>
    ...
    <div className="min-h-screen bg-[#09090b] relative">
      ...
      <div className="max-w-2xl mx-auto p-6 relative">
        ...
        <motion.div
          initial={{ opacity: 0, y: 15 }}
          animate={{ opacity: 1, y: 0 }}
          className="rounded-2xl border border-white/10 bg-gradient-to-br from-blue-500/10 via-purple-500/5 to-transparent p-6 mb-6 flex items-center gap-6"
        >
