      ...
      items: [
        ...
        },
        {
          ...
          children: [
            ...
            { key: 'om:scan_pack_flow2', label: 'Dokumentasi Packing' },
        ...
        },
        {
          ...
          children: [
            ...
            { key: 'abs:points:history', label: 'Riwayat Poin' },
            { key: 'abs:owner:dashboard', label: 'Dashboard Owner', ownerOnly: true },
            { key: 'abs:owner:report', label: 'Laporan Absensi', ownerOnly: true },
...
function bottomNavForModule(moduleKey, user) {
  ...
  if (moduleKey === 'order_management') {
    ...
    const items = [
      ...
      { key: 'om:scan_pack_flow1', label: 'Serah Terima', icon: ScanBarcodeIcon },
      { key: 'om:scan_pack_flow2', label: 'Dokumentasi', icon: Package },
...
function MobileTopBar({ user, active, onNav, onLogout }) {
  ...
  const labels = {
    ...
    'abs:owner:report': 'Absensi · Laporan',
    'abs:owner:overtime': 'Absensi · Approval Lembur',
    'abs:points:board': 'Reward Poin · Live Board',
    'abs:points:history': 'Reward Poin · Riwayat',
    'abs:points:settings': 'Reward Poin · Pengaturan',
    'abs:owner:settings': 'Absensi · Pengaturan',
